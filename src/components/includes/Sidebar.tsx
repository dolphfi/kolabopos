...
export function Sidebar({ className }: React.HTMLAttributes<HTMLDivElement>) {
    ...
    return (
        <TooltipProvider>
            <div className={cn("bg-black/40 backdrop-blur-xl border-r border-white/10 text-white h-full transition-all duration-300 flex flex-col", isSidebarOpen ? "w-64" : "w-20", className)}>
                                ...
                                <AccordionItem value="vente" className="border-b-0">
                                    ...
                                    <AccordionContent className="pb-0 pl-10">
                                        <div className="space-y-1 mt-1">
                                            <Button variant="ghost" size="sm" className="w-full justify-start h-8 hover:bg-white/10 hover:text-white" asChild>
                                                <Link to="/pos">
